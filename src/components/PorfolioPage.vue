<template>
    <v-container mt-12 pa-3 info rounded id="portfolio">
        <v-row>
            <v-col cols="12">
                <h2 class="font-weight-black text-center">Portfolio</h2>
                <br />
                <v-row wrap>
                    <v-col
                        class="col-sm-6 col-md-4 col-lg-3 px-0"
                        v-for="site in sites"
                        :key="site.key"
                    >
                        <v-hover>
...
export default {
    ...
    data: () => ({
        ...
        sites: [
            ...
            // {
            //   key: 'g2gotravelclub.net',
            //   name: 'G2GoTravelClub.net',
            //   stack: [tech.vuejs,tech.vuetify],
            //   url: 'http://guest.g2gotravelclub.net',
            //   description:
            //     'Direct sales companion of G2GoTravelClub.com features automatic duplication across custom subdomains for registered users.'
            // },
            {
                key: "fivestar",
            ...
            },
            {
                ...
                url: "https://jddudley.com/games/tictactoe/",
                description:
